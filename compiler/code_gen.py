...
class CodeGenerator:
    ...
    def __expr_div(self, x, lineno):
        ...
        codes.append(Code('EMPTY', label=label6))

        codes.append(Code('LOAD', 11))
        codes.append(Code('JNEG', offset=label9))
        codes.append(Code('LOAD', 12))
        codes.append(Code('JPOS', offset=label9))
        codes.append(Code('SUB', 0))
        codes.append(Code('SUB', 17))
        codes.append(Code('STORE', 17))
        codes.append(Code('LOAD', 15))
        codes.append(Code('JZERO', offset=label10))
        codes.append(Code('LOAD', 17))
        codes.append(Code('DEC'))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('LOAD', 17, label=label10))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('LOAD', 11, label=label9))  #
        ...
        codes.append(Code('STORE', 17))
        codes.append(Code('LOAD', 15))
        codes.append(Code('JZERO', offset=label12))
        codes.append(Code('LOAD', 17))
        codes.append(Code('DEC'))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('LOAD', 17, label=label12))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('LOAD', 17, label=label11))  #
    ...
    def __expr_mod(self, x, lineno):
        ...
        codes.append(Code('LOAD', 15))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('LOAD', 15, label=label9))
        codes.append(Code('ADD', 12))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('LOAD', 12, label=label10))
        codes.append(Code('JNEG', offset=label11))
        codes.append(Code('LOAD', 12))
        codes.append(Code('SUB', 15))
        codes.append(Code('JUMP', offset=label8))
        codes.append(Code('SUB', 0, label=label11))
        codes.append(Code('SUB', 15))
